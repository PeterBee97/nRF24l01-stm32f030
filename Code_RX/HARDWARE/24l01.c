...
const uint8_t TX_ADDRESS[TX_ADR_WIDTH]={0xDE,0xAD,0xBE,0xEF,0x01}; //发送地址
const uint8_t RX_ADDRESS[RX_ADR_WIDTH]={0xDE,0xAD,0xBE,0xEF,0x01}; //接收地址
...
{  
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
	...
	GPIO_ResetBits(GPIOB,GPIO_Pin_1); 			//使能24L01 CE=0
