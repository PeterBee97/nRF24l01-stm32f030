...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
//#define NRF24L01_CE   PAout(1) //24L01片选信号 PA1

#define NRF24L01_CE_SET     (GPIOA->BSRR = GPIO_Pin_1)	   
#define NRF24L01_CE_CLR     (GPIOA->BRR  = GPIO_Pin_1)

//#define NRF24L01_CSN  PAout(4) //SPI片选信号	PA4
#define NRF24L01_CSN_SET     (GPIOA->BSRR = GPIO_Pin_4)	   
#define NRF24L01_CSN_CLR     (GPIOA->BRR  = GPIO_Pin_4)
...
uint8_t NRF24L01_RxPacket(uint8_t *rxbuf,uint8_t len);//接收一个包的数据
#endif
